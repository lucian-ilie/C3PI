...
from tensorflow.keras.layers import Dense, Flatten, Dropout, Input, Conv1D, Conv1D, Concatenate
...
valPartition = partitioning("dataset/pairs/human_validation.tsv", 1)
...
mc = ModelCheckpoint("models/CNN1D.h5", save_weights_only=True, monitor='val_loss',
